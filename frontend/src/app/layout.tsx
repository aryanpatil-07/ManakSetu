          ...
          <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[10px] tracking-widest text-slate-400 uppercase font-medium">BIS Tender Scrutiny Engine</div>
              </div>
            </Link>
            ...
            <nav className="flex items-center gap-1 md:gap-2">
              <Link
                href="/"
                className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs md:text-sm font-medium text-slate-300 hover:text-white hover:bg-slate-800/80 transition"
              >
